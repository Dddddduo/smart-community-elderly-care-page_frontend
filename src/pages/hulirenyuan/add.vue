...
<div :style='{"width":"100%","padding":"30px 10% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="120px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="护理账号" prop="hulizhanghao">
            <el-input v-model="ruleForm.hulizhanghao" 
                placeholder="护理账号" clearable :disabled=" false  ||ro.hulizhanghao"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="护理姓名" prop="hulixingming">
            <el-input v-model="ruleForm.hulixingming" 
                placeholder="护理姓名" clearable :disabled=" false  ||ro.hulixingming"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="入职日期" prop="ruzhiriqi">
              <el-date-picker
				  :disabled=" false  ||ro.ruzhiriqi"
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="工作状态" prop="gongzuozhuangtai">
            <el-input v-model="ruleForm.gongzuozhuangtai" 
                placeholder="工作状态" clearable :disabled=" false  ||ro.gongzuozhuangtai"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="工作负荷" prop="gongzuofuhe">
            <el-input v-model="ruleForm.gongzuofuhe" 
                placeholder="工作负荷" clearable :disabled=" false  ||ro.gongzuofuhe"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="位置" prop="weizhi">
...
<script>
  export default {
    ...
    // 多级联动参数
      // 多级联动参数
      info() {
        this.$http.get(`hulirenyuan/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
			...
			this.$refs["ruleForm"].validate(valid => {
				if(valid) {
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('hulirenyuan/list', {
							params: params
						}).then(res => {
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`hulirenyuan/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
