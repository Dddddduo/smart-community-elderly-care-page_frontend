...
<div :style='{"width":"100%","padding":"30px 10% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="家庭住址" prop="jiatingzhuzhi">
            <el-input v-model="ruleForm.jiatingzhuzhi" 
                placeholder="家庭住址" clearable :disabled=" false  ||ro.jiatingzhuzhi"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="身体状况" prop="shentizhuangkuang">
            <el-input v-model="ruleForm.shentizhuangkuang" 
                placeholder="身体状况" clearable :disabled=" false  ||ro.shentizhuangkuang"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="社区" prop="shequ">
            <el-select v-model="ruleForm.shequ" placeholder="请选择社区" :disabled=" false  ||ro.shequ" >
              <el-option
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/shequ/shequ', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            this.shequOptions = res.data.data;
          }
        });
